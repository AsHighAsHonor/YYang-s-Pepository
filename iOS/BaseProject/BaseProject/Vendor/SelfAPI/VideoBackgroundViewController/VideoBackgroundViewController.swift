...
open class VideoBackgroundViewController: UIViewController {
    ...
    open var videoScalingMode: VideoScalingMode = .resizeAspectFill {
        didSet {
            ...
            case .resize:
                videoPlayer.videoGravity = AVLayerVideoGravity(rawValue: AVLayerVideoGravity.resize.rawValue)
            case .resizeAspect:
                videoPlayer.videoGravity = AVLayerVideoGravity(rawValue: AVLayerVideoGravity.resizeAspect.rawValue)
            case .resizeAspectFill:
                videoPlayer.videoGravity = AVLayerVideoGravity(rawValue: AVLayerVideoGravity.resizeAspectFill.rawValue)
            }
        }
    }
