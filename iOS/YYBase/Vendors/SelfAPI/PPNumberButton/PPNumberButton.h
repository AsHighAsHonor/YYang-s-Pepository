...
extern NSString *const PPNumberTextFieldWillBeginEditNotification;
extern NSString *const PPTextField;
...
/** 设置圆角按钮 */
@property(nonatomic,assign, getter = isRouded)IBInspectable BOOL rounded;


@property(nonatomic,strong) NSAttributedString *attrTitle;

@property(nonatomic,assign,getter=isModify)IBInspectable BOOL modify;

@property(nonatomic,assign)IBInspectable BOOL disableInput;
